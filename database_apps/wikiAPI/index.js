...
const newArticleSchema=new mongoose.Schema({title:{type:String,required:[!0,"Please check your data entry, no name specified"]},content:{type:String,required:[!0,"Please fill this information out! I would really appreciate it."]}}); 
